...
def view_presets_keyboard(presets):
    ...
    for preset in presets:
        ...
        keyboard.append([InlineKeyboardButton(name, callback_data=f"move_preset_detail-{preset_id}")])
...
def preset_detail_keyboard(preset_id):
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("Edit", callback_data=f"move_preset_edit-{preset_id}")],
        [InlineKeyboardButton("Delete", callback_data=f"move_preset_delete_confirm-{preset_id}")],
        [InlineKeyboardButton("Back to List", callback_data="move_preset_view")],
    ])

def delete_confirm_keyboard(preset_id):
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("Yes, Delete", callback_data=f"move_preset_delete-{preset_id}")],
        [InlineKeyboardButton("Cancel", callback_data=f"move_preset_detail-{preset_id}")],
    ])
